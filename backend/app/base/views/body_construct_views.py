...
def get_page_construction():
    ...
    structure = page_construct_mod.PageConstruction.get_structure(current_user, page_name)
...
def get_component_name():
    ...
    if type_data is not None:
        name_component = page_construct_mod.STDComponentName.get_component_name(type_data)
