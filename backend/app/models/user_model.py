...
class STDStatusUser(ParentModels):
    ...
    priority = db.Column(db.Integer, unique=True)  # 100, 200, 300 для сравнения
...
class User(ParentModels):
    ...
    created_nodes = relationship("ReactFlowNode", back_populates="created_by_rel")
    created_schemas = relationship("ReactFlowSchema", back_populates="created_by_rel")
