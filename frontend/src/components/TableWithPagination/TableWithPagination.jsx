...
import EditFunc from "../EditFunc/EditFunc";
import './TableWithPagination.css';

function TableWithPagination({ token, table_name, searchQuery, onDataUpdated, refreshKey, count_sheet }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [headersResponse, dataResponse] = await Promise.all([
                    axios.get('/WorkOST/table_views/getNameHead', {
                        headers: { Authorization: `Bearer ${token}` },
                        params: { table_name }
                    }),
                    axios.get('/WorkOST/table_views/getDataTable', {
                        headers: { Authorization: `Bearer ${token}` },
                        params: {
                            table_name,
                            page: currentPage,
                ...
                setColumns(headersResponse.data.filter(c => c?.column_name_show));
        ...
        fetchData();
    }, [token, table_name, searchQuery, currentPage, refreshKey, sortConfig, perPage]);
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await axios.delete("/flaskCuda/edit_del/delRow", {
                headers: { Authorization: `Bearer ${token}` },
...
//             try {
//                 const [headersResponse, dataResponse] = await Promise.all([
//                     axios.get('/flaskCuda/working/getNameHead', {
//                         headers: { Authorization: `Bearer ${token}` },
//                         params: { table_name }
//                     }),
//                     axios.get('/flaskCuda/working/getDataTable', {
//                         headers: { Authorization: `Bearer ${token}` },
//                         params: {
//                             table_name,
//                             page: currentPage,
